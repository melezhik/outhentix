...
cmp-ok $otx.results[0]<message>, '~~', /'[b] output match' .* 'once'/, 'correct message (once)';
cmp-ok $otx.results[1]<message>, '~~', /'[b] output match' .* 'upon a time'/, 'correct message (upon a time)';
cmp-ok $otx.results[2]<message>, '~~', /'[b] output match' .* 'there was'/, 'correct message (there was)';
