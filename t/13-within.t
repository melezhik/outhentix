...
cmp-ok $otx.results[0]<type>, 'eq', 'check-expression', 'correct type (within regexp check)';

cmp-ok $otx.results[1]<message>, '~~', /'HELLO WORLD!!!' .* 'match \'WORLD ...'/, 'correct message (regexp check world)';
cmp-ok $otx.results[1]<type>, 'eq', 'check-expression', 'correct type (plain text check - hello)';
